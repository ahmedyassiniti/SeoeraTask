...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>Seoera</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              @if(!empty(Session::get('AdminData.name')))
              {{ Session::get('AdminData.email')}}
              @else
              {{'admin'}}
              @endif
            </span>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p> @if(!empty(Session::get('AdminData.name')))
              {{ Session::get('AdminData.email')}}
              @else
              {{'admin'}}
              @endif</p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{URL::route('languages.index')}}"><i class="fa fa-ship" aria-hidden="true"></i>Languages</a></li>
           
            <li><a href="{{URL::route('products.index')}}"><i class="fa fa-circle-o"></i>Products</a></li>
             <li><a href="{{URL::route('admins.create')}}"><i class="fa fa-circle-o"></i>Add Admin</a></li>
             <li><a href="{{URL::route('users.index')}}"><i class="fa fa-circle-o"></i>Activate/Deactivate Users</a></li>
...
<!--ahmed yassin about change header of section 17/4/2018 -->
